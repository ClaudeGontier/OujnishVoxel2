...
public class Teub extends Structure {

    public static final Codec<Teub> CODEC = RecordCodecBuilder.<Teub>mapCodec(instance ->
            instance.group(Teub.configCodecBuilder(instance),
    ...
    public Teub(Structure.Config config,
